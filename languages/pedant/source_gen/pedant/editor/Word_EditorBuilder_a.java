...
/*package*/ class Word_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.contents$Km4D;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no contents>");
      editorCell.setCellId("property_contents");
  ...
  private static final class PROPS {
    /*package*/ static final SProperty contents$Km4D = MetaAdapterFactory.getProperty(0xe1654c1208bf4d54L, 0x9998af58f6362837L, 0x59c371a1e9b64cc9L, 0x59c371a1e9c2bd7bL, "contents");
  }

...
"""
Taken from:  https://github.com/timofurrer/pandoc-plantuml-filter/blob/master/pandoc_plantuml_filter.py
        ...
        if "plantuml" in classes:
            ...
            if not os.path.isfile(dest):
                ...
                subprocess.check_call(PLANTUML_BIN.split() +
                                      ["-t" + filetype, src], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
